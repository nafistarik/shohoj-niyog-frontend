...
function AllowedCandidatesItem({ email, copiedEmails, copyToClipboard, generateInviteLink }: { email: string, copiedEmails: string[], copyToClipboard: (link: string, email: string) => void, generateInviteLink: (email: string) => string }) {
    return (
        <div
            key={email}
